...
public class CmdLineArgs {
	...
	public String getCommand() {
		...
		else if (command.equals("connect_peers") && server != null && peer != null) return "CONNECT_PEER_REQUEST";
		else if (command.equals("disconnect_peers") && server != null && peer != null) return "DISCONNECT_PEER_REQUEST";
		else return "INVALID";
	}
	...
	public boolean isValid() {
		...
		else if (command.equals("connect_peers") && server != null && peer != null) return true;
		else if (command.equals("disconnect_peers") && server != null && peer != null) return true;
		else return false;
	}
}
